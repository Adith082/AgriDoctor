...
public class ExternalApiControllers {
	...
	public CropDiseaseDetectionResponse callCropDiseaseDetectionExternalApi(@RequestParam("input_data") MultipartFile file, @RequestParam("uid") Integer uid) throws IOException  {
		  //   System.out.println("HELLO FROM CROP DISEASE DETECTION");
			return cropDiseaseDetectionApiServices.callCropDiseaseDetectionApi(file, uid);
